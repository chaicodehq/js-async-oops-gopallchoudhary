...
export function placeOrder(restaurant, items) {
  ...
  return new Promise((resolve, reject) => {
    if (typeof restaurant !== 'string' || restaurant.length <= 0 || items.length === 0) return reject(new Error("Invalid order details!"))
...
export function confirmOrder(order) {
  // Your code here
  return new Promise((resolve, reject) => {
    if (!order.orderId || order.status !== 'placed') return reject(new Error("Order cannot be confirmed!"))
...
export function assignRider(order) {
  // Your code here
  return new Promise((resolve, reject) => {
    if (order.status !== 'confirmed') return reject(new Error("Order not confirmed yet!"))
...
export function deliverOrder(order) {
  // Your code here
  return new Promise((resolve, reject) => {
    if (order.status !== 'assigned' || !order.rider) return reject(new Error("No rider assigned!"))
