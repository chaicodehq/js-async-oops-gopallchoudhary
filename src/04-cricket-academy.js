...
export class Batsman extends Player {
  ...
  playInnings(runs, balls) {
    // Your code here
    if (runs <= 0 || balls <= 0 || typeof runs !== 'number' || typeof balls !== 'number') return null
  ...
  getStrikeRate() {
    ...
    const totalStrikeRate = this.innings.reduce((acc, currentValue) => acc + currentValue.strikeRate, 0)
  ...
  getProfile() {
    // Your code here
    const totalRuns = this.innings.reduce((acc, currentValue) => acc + currentValue.runs, 0)
...
export class Bowler extends Player {
  ...
  bowlSpell(wickets, runsConceded, overs) {
    // Your code here
    if (runsConceded <= 0 || overs <= 0 || wickets < 0 || [wickets, runsConceded, overs].some((item) => typeof item !== 'number')) return null
  ...
  getEconomy() {
    ...
    const totalEconomy = this.spells.reduce((acc, currentValue) => acc + currentValue.economy, 0)
  ...
  getProfile() {
    // Your code here
    const totalWickets = this.spells.reduce((acc, currentValue) => {
      return acc + currentValue.wickets
    }, 0)
...
export class AllRounder extends Player {
  ...
  getProfile() {
    // Your code here
    const totalRuns = this.innings.reduce((acc, currentValue) => acc + currentValue.runs, 0)
    const totalWickets = this.spells.reduce((acc, currentValue) => acc + currentValue.wickets, 0)
